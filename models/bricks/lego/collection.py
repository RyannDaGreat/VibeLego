"""
LEGO brick collection -- all LEGO brick types arranged in a display grid.

Command, specific. Generates every LEGO brick type and arranges them in rows
by category (bricks, plates, slopes) with 5x PITCH (40mm) spacing.
...
from lego_lib import lego_brick, lego_slope, PITCH, PLATE_HEIGHT
...
def make_collection():
    """
    Command, specific. Build all LEGO brick types and arrange in a grid.
